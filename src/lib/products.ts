...
export const products = [
  ...
  },
  {
    id: "interbolt",
    name: "Interbolt",
    description: "More on Interbolt Tools",
  },
  {
    id: "alkitronic",
    name: "Alkitronic",
    ...
    headerContent: [
      {
        ...
        statement:
          "Hi-Force is the leading designer, manufacturer and supplier of hydraulic tools. The product range comprises of over 2,000 products including hydraulic cylinders, pumps, jacks, toughlift jacking systems, torque tools, bolt tensioners, hydrotest pumps, puller kits, crimpers and cutters, nut splitters, flange spreaders and other industry related products.",
      },
    ],
    bodyContent: [
      {
