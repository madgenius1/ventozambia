...
/**
 * Hero Component for Vento Zambia Limited.
 * This component displays the company's title, a brief description,
 * call-to-action buttons, and a dynamically shuffling grid of images.
 */
